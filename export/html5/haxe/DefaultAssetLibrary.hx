...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		super();
		// register assets:
		add("assets/CoasterBoy.ttf", FONT);
		add("assets/data/data-goes-here.txt", TEXT);
		add("assets/images/arrows.png", IMAGE);
		add("assets/images/bg.png", IMAGE);
		add("assets/images/btngraphic.png", IMAGE);
		add("assets/images/btngraphic.png.pyxel", BINARY);
		add("assets/images/enemy.png", IMAGE);
		add("assets/images/hardenemy.png", IMAGE);
		add("assets/images/images-go-here.txt", TEXT);
		add("assets/images/logo.png", IMAGE);
		add("assets/images/ohlogo - Copy.png", IMAGE);
		add("assets/images/ohlogo.png", IMAGE);
		add("assets/images/player.png", IMAGE);
		add("assets/images/space.png", IMAGE);
		add("assets/images/space2.png", IMAGE);
		add("assets/images/spikeball.png", IMAGE);
		add("assets/images/spikeball.pyxel", BINARY);
		add("assets/images/subwindow.png", IMAGE);
		add("assets/images/wall.png", IMAGE);
		add("assets/music/music-goes-here.txt", TEXT);
		add("assets/music/music.wav", SOUND);
		add("assets/sounds/bounce.wav", SOUND);
		add("assets/sounds/hit.wav", SOUND);
		add("assets/sounds/sounds-go-here.txt", TEXT);
		add("assets/sounds/startup.wav", SOUND);
