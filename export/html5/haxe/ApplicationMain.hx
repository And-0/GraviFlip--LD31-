...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/images/arrows.png");
		loadFile("assets/images/bg.png");
		loadFile("assets/images/btngraphic.png");
		loadBinary("assets/images/btngraphic.png.pyxel");
		loadFile("assets/images/enemy.png");
		loadFile("assets/images/hardenemy.png");
		loadBinary("assets/images/images-go-here.txt");
		loadFile("assets/images/logo.png");
		loadFile("assets/images/ohlogo - Copy.png");
		loadFile("assets/images/ohlogo.png");
		loadFile("assets/images/player.png");
		loadFile("assets/images/space.png");
		loadFile("assets/images/space2.png");
		loadFile("assets/images/spikeball.png");
		loadBinary("assets/images/spikeball.pyxel");
		loadFile("assets/images/subwindow.png");
		loadFile("assets/images/wall.png");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/music/music.wav");
		loadSound("assets/sounds/bounce.wav");
		loadSound("assets/sounds/hit.wav");
		loadBinary("assets/sounds/sounds-go-here.txt");
		loadSound("assets/sounds/startup.wav");
