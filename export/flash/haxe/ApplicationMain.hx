...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/CoasterBoy.ttf");
		...
		urls.push ("assets/images/arrows.png");
		...
		urls.push ("assets/images/btngraphic.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/btngraphic.png.pyxel");
		types.push (AssetType.BINARY);
		
		
		urls.push ("assets/images/enemy.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/hardenemy - Copy.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/hardenemy.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/images/ohlogo - Copy.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/ohlogo.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/images/space.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/space2.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/spikeball.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/spikeball.pyxel");
		types.push (AssetType.BINARY);
		
		
		urls.push ("assets/images/subwindow.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/music/music.mp3");
		...
		urls.push ("assets/music/music.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/bounce.wav");
		types.push (AssetType.SOUND);
		...
		urls.push ("assets/sounds/startup.wav");
		types.push (AssetType.SOUND);
	...
	public static function main () {
		...
		#if js
		#if munit
		flash.Lib.embed (null, 640, 576, "000000");
		#end
		#else
		create ();
		#end
