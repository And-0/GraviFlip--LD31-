...
HX_STACK_THIS(this)
{
	...
	this->zoom = (int)-1;
	HX_STACK_LINE(15)
	this->initialState = hx::ClassOf< ::LogoState >();
	HX_STACK_LINE(14)
	this->gameHeight = (int)288;
	HX_STACK_LINE(13)
...
Void Main_obj::init( ::openfl::_v2::events::Event E){
{
		...
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(44)
		if ((this->hasEventListener(::openfl::_v2::events::Event_obj::ADDED_TO_STAGE))){
			HX_STACK_LINE(46)
...
Void Main_obj::setupGame( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(54)
		int stageWidth = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(stageWidth,"stageWidth");
		HX_STACK_LINE(55)
		int stageHeight = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageHeight();		HX_STACK_VAR(stageHeight,"stageHeight");
		HX_STACK_LINE(57)
		if (((this->zoom == (int)-1))){
			HX_STACK_LINE(59)
