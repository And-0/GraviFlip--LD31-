...
::EReg_obj::__register();
::__ASSET__assets_coasterboy_ttf_obj::__register();
...
::__ASSET__assets_coasterboy_ttf_obj::__boot();
...
::LogoState_obj::__boot();
::IMap_obj::__boot();
::MenuState_obj::__boot();
::PlayState_obj::__boot();
::Player_obj::__boot();
::Reflect_obj::__boot();
::Spikeball_obj::__boot();
