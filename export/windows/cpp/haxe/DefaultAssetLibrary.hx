...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_coasterboy_ttf);
...
@:keep #if display private #end class __ASSET__assets_coasterboy_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "assets/CoasterBoy.ttf"; } #end }
